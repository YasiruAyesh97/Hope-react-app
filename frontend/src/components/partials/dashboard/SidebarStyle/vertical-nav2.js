    ...
    return (
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                {(() => {
                    if (allowedRoles.find(role => role =="ROLE_SUPERADMIN")) {
                        return <>
                            <Accordion.Item as="li" eventKey="sidebar-super-admin" bsPrefix="nav-item">
                                ...
                                <Accordion.Collapse eventKey="sidebar-super-admin">
                                    <ul className="sub-nav">
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/admin-add' ? 'active' : ''} nav-link`} to="admin-add">
                                                <i className="icon">
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/admin-list' ? 'active' : ''} nav-link`} to="admin-list">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <Accordion.Item as="li" eventKey="sidebar-company" bsPrefix="nav-item">
                                ...
                                <Accordion.Collapse eventKey="sidebar-company">
                                    <ul className="sub-nav">
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/company-add' ? 'active' : ''} nav-link`} to="company-add">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/company-list' ? 'active' : ''} nav-link`} to="company-list">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
             ...
             {/* manage user  */}
                ...
                {(() => {
                    if (allowedRoles.find(role => role =="ROLE_ADMIN")) {
                        return <>
                            ...
                            <Accordion.Item as="li" eventKey="sidebar-cataogs" bsPrefix="nav-item">
                                ...
                                <Accordion.Collapse eventKey="sidebar-cataogs">
                                    <ul className="sub-nav">
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/catalog-list1' ? 'active' : ''} nav-link`} to="catalog-list1">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/catalog-list2' ? 'active' : ''} nav-link`} to="catalog-list2">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/catalog-list3' ? 'active' : ''} nav-link`} to="catalog-list3">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/catalog-add' ? 'active' : ''} nav-link`} to="catalog-add">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                {/*Catalog*/}
                {(() => {
                    if (allowedRoles.find(role => role =="ROLE_ADMIN" || role =="ROLE_USER")) {
                        return <>
                            <Accordion.Item as="li" eventKey="sidebar-documents" bsPrefix="nav-item">
                                ...
                                <Accordion.Collapse eventKey="sidebar-documents">
                                    <ul className="sub-nav">
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/document-add' ? 'active' : ''} nav-link`} to="document-add">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/document-list' ? 'active' : ''} nav-link`} to="document-list">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
